...
extern "C" __global__ void hidden_layer_gradient_kernel(const float* __restrict__ Weights,
                                                        ...
                                                        int M, int N, int K)
{
    ...
    Write_Layer_Gradient_Tile(This_Layer_Gradient,
                              This_Layer_z,
                              norm_factor,
                              registers,
                              M, N, i0, j0, warp_row, warp_col, thr_row, thr_col);
